...
type
  Tfrmprincipal = class(TForm)
    ...
    LlegadaPlanillas1: TMenuItem;
    Punteo1: TMenuItem;
    PlanillasConciliadas1: TMenuItem;
    IngresodeCampos1: TMenuItem;
    qryborrar: TADOQuery;
   ...
   function espacios(tamano:integer;cadena:string):string;
    ...
    procedure Punteo1Click(Sender: TObject);
    procedure PlanillasConciliadas1Click(Sender: TObject);
    procedure IngresodeCampos1Click(Sender: TObject);
...
uses Uacerca, dtmodulo, Uglobal, LoginFrm, Ubancos, Uarchivos,
  ...
  Urecepcion, UconsultaResagos, ucamposformato;
...
procedure Tfrmprincipal.Punteo1Click(Sender: TObject);
begin
 frmrecepcion:=Tfrmrecepcion.create(application);
   try
   frmrecepcion.show;
   //finally
   except
...
procedure Tfrmprincipal.PlanillasConciliadas1Click(Sender: TObject);
begin
...
procedure Tfrmprincipal.IngresodeCampos1Click(Sender: TObject);
begin


 frmcampos:=Tfrmcampos.create(application);
   try
   frmcampos.show;
   //finally
   except

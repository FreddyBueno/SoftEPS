...
TYPE
  TFRMINCAPACIDADESTUTELA=CLASS(TFORM)
    PANEL2: TPANEL;
    PANEL3: TPANEL;
    QRYAFILIADOS: TQUERY;
    ...
    qrybuscarcompensacion2: TADOQuery;
    qrybuscarcompensacion2PER_COTIZACION: TStringField;
    Label29: TLabel;
    dtpfecfallo: TDateTimePicker;
    edtfallo: TEdit;
    Label30: TLabel;
    ...
    procedure Button6TClick(Sender: TObject);
...
VAR
  FRMINCAPACIDADESTUTELA:TFRMINCAPACIDADESTUTELA;
  ENCONTRO : BOOLEAN;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.FORMCLOSE(SENDER: TOBJECT;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.FORMCREATE(SENDER: TOBJECT);
BEGIN
...
WITH SGDETALLEINC DO
  BEGIN
    ...
    DTPFECFALLO.DATE := STRTODATE(GLDATE);
    EDTNUMERO.TEXT := '0';
    //EDTNUMERO.SETFOCUS;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTDIASINCAPACIDADKEYPRESS(SENDER: TOBJECT; VAR KEY: CHAR);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTNUMDOCEMPRESAEXIT(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTPROLIQUIDACIONEXIT(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTNUMEROEXIT(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTNUMDOCAFILIADOINEXIT(SENDER: TOBJECT);
BEGIN
  ...
  //  DATAMODULE1.QRYAFILIADOS.PREPARE;
    ...
    DATAMODULE1.QRYAFILIADOS.Parameters[0].VALUE := TRIM(FRMINCAPACIDADESTUTELA.CBTIPODOCAFILIADO.TEXT);
    DATAMODULE1.QRYAFILIADOS.Parameters[1].VALUE := TRIM(FRMINCAPACIDADESTUTELA.EDTNUMDOCAFILIADOIN.TEXT);
    ...
    DATAMODULE1.QRYAFILIADOS.OPEN;
        ...
        BEGIN
                ...
                //CUATROSEMANASAFILIACION;     ***TUTELA***
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTCODDIAGNOSTICOEXIT(SENDER: TOBJECT);
 BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.LIMPIAR;
VAR I : INTEGER;
BEGIN
Edit1.Text := '0';
Edit2.Text := '';
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTNUMEROENTER(SENDER: TOBJECT);
BEGIN
IF EDTNUMERO.TEXT = '0' THEN
  BEGIN
  LIMPIAR;
...
{*PROCEDURE TFRMINCAPACIDADESTUTELA.DTPFECINICIACIONEXIT(SENDER: TOBJECT);
VAR
VALIDAR:BOOLEAN;
MESINI, AINI, CONT:INTEGER;
BEGIN
...
{*         BEGIN
         ...
         BEGIN
         WHILE NOT (QRYBUSCARCOMPENSACION.Eof) AND (CONT <3) DO
         BEGIN
           IF MESINI=12 THEN
           BEGIN
              MESINI:=1;
              AINI :=AINI+1
           END
           ELSE MESINI:=MESINI+1;
           IF QRYBUSCARCOMPENSACIONPER_COTIZACION.Value=INTTOSTR(MESINI)+INTTOSTR(AINI) THEN
              VALIDAR:=TRUE
           ELSE
...
PROCEDURE TFRMINCAPACIDADESTUTELA.PAGOLINCENCIAS;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTDIASINCAPACIDADEXIT(SENDER: TOBJECT);
var dias : integer;LIMITEDIAS:STRING;
BEGIN
//****************************
QRYAPROBACIONES.Close;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTNUMDOCAFILIADOINCLICK(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.RGTIPOINCAPACIDADEXIT(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTNUMDOCEMPRESACHANGE(SENDER: TOBJECT);
BEGIN
IF EDTNUMDOCEMPRESA.TEXT > '0' THEN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTCODPRESTADOREXIT(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.REFRESCAR_INCAPACIDAD;
VAR I : INTEGER;
BEGIN
                             ...
                             ELSE IF DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('TIP_INCAPACIDAD').VALUE = 'ARP' THEN
                                     ...
                                     ELSE IF DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('TIP_INCAPACIDAD').VALUE = 'SOA' THEN
                                          BEGIN
                                               ...
                                               END;
        IF  DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('NUMERO_TUTELA').VALUE <>NULL THEN
        BEGIN
        EDTFALLO.TEXT := DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('NUMERO_TUTELA').VALUE;
        END
        ELSE
        BEGIN
        EDTFALLO.Text:='';
        END;
        IF DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('FEC_FALLO_TUTELA').VALUE<>NULL THEN
        BEGIN
        DTPFECFALLO.DATE := DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('FEC_FALLO_TUTELA').VALUE;
        END
        ELSE
        BEGIN
        DTPFECFALLO.DATE :=STRTODATE(GLDATE);
...
PROCEDURE TFRMINCAPACIDADESTUTELA.BUTTON3CLICK(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.DIASLIQUIDADOS;
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.PAGOEFERMEDADGENERAL;
VAR MES,DIA,ANO : STRING;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.GRABARINCAPACIDADES;
VAR I : INTEGER;
BEGIN
...
BEGIN
 ...
 TRY
     ...
     DATAMODULE1.QRYINCAPACIDADES.OPEN;
        ...
        DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('NUMERO_TUTELA').VALUE :=EDTFALLO.Text;
        DATAMODULE1.QRYINCAPACIDADES.FIELDBYNAME('FEC_FALLO_TUTELA').VALUE :=DTPFECFALLO.DATE;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.BUTTON2CLICK(SENDER: TOBJECT);
BEGIN
IF MESSAGEDLG ('Confirma La Grabación del número de Incapacidad ' +Edtnumero.Text + ' para el afiliado '+Edtnombreafiliado.Text + ' con fecha de fallo '+DATETOSTR(dtpfecfallo.Date)+' por accion de tutela', MTCONFIRMATION, [MBYES, MBNO], 0) = MRYES THEN
BEGIN
...
FUNCTION TFRMINCAPACIDADESTUTELA.VALIDAR: BOOLEAN;
BEGIN
VALIDAR := FALSE;
...
IF EDTFALLO.Text='' THEN
  BEGIN
   VALIDAR := TRUE;
   SHOWMESSAGE(LowerCase('EL NUMERO FALLO ESTA EN BLANCO'));
   END;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTSALARIOBASEENTER(SENDER: TOBJECT);
BEGIN
DIASLIQUIDADOS;
END;
...
PROCEDURE TFRMINCAPACIDADESTUTELA.VERIFICAR_INCAPACIDADES;
  VAR  I : INTEGER;
...
BEGIN
     ...
     END;
END;
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTCODDIAGNOSTICOCLICK(SENDER: TOBJECT);
BEGIN
 IF EDTNUMDOCAFILIADOIN.TEXT = '0' THEN
    BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.EDTPROLIQUIDACIONCLICK(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.VERIFICAR_CARTERA;
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.APPMESSAGE(VAR MSG: TMSG;
  VAR HANDLED: BOOLEAN);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.CERRAR1CLICK(SENDER: TOBJECT);
BEGIN
FRMINCAPACIDADESTUTELA.CLOSE
END;

PROCEDURE TFRMINCAPACIDADESTUTELA.ENVIARWORD;
VAR
...
PROCEDURE TFRMINCAPACIDADESTUTELA.USUARIOS1CLICK(SENDER: TOBJECT);
BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.INCAPACIDADVIGENTE;
VAR
...
BEGIN
     ...
     DATAMODULE1.QRYINCAPACIDADES.OPEN;
        ...
        ELSE IF RGTIPOINCAPACIDAD.ITEMINDEX = 3 THEN
                FRMINCAPACIDADESTUTELA.EDTDIASINCAPACIDAD.OnExit
                ELSE}
                IF EDTDIASINCAPACIDAD.Enabled=TRUE THEN
                edtdiasincapacidad.SETFOCUS
                ELSE
                FRMINCAPACIDADESTUTELA.EDTDIASINCAPACIDADEXIT(NIL);
...
procedure TFRMINCAPACIDADESTUTELA.liquidar_incapacidad;
VAR I : INTEGER;
 BEGIN
           ...
           BEGIN
             IF EDTDIASLIQUIDADOS.TEXT > '0' THEN
                ...
                BEGIN
                     ...
                     END;
                END
                ELSE IF (RGTIPOINCAPACIDAD.ITEMINDEX = 2) OR (STRTOINT(EDTDIASLIQUIDADOS.Text)>30) THEN //*** THEN
                        BEGIN
                        IF EDTDIASLIQUIDADOS.TEXT > '0' THEN
                        BEGIN
                        FOR I := 1 TO SGDETALLEINC.ROWCOUNT DO
...
Function TFRMINCAPACIDADESTUTELA.xIntToLletres(Numero:LongInt):String;
var
...
Function TFRMINCAPACIDADESTUTELA.xxIntToLletres(Valor:LongInt):String;
const
...
procedure TFRMINCAPACIDADESTUTELA.Button1Click(Sender: TObject);
...
procedure TFRMINCAPACIDADESTUTELA.dtpfecexpedicionExit(Sender: TObject);
begin
...
procedure TFRMINCAPACIDADESTUTELA.cbtipodocempresaExit(Sender: TObject);
begin
...
procedure TFRMINCAPACIDADESTUTELA.cbtipodocafiliadoExit(Sender: TObject);
begin
...
procedure TFRMINCAPACIDADESTUTELA.Edit1Exit(Sender: TObject);
  VAR  I : INTEGER;
begin
...
procedure TFRMINCAPACIDADESTUTELA.chprorrogaClick(Sender: TObject);
begin
    if  chprorroga.Checked = true then
    begin
...
procedure TFRMINCAPACIDADESTUTELA.btneliminarClick(Sender: TObject);
begin
 if Edtnumero.Text > '0' then
 begin
...
procedure TFRMINCAPACIDADESTUTELA.Button4Click(Sender: TObject);
begin
GLPROCESO := 'INCAPACIDADES';
FRMPRINCIPAL.SB.PANELS[1].TEXT := 'PROCESO ABIERTO ACTUAL  :'+ GLPROCESO;
FRMEMPRESAS:=TFRMEMPRESAS.CREATE(APPLICATION);
TRY
FRMEMPRESAS.Caption:='Empresas con Afiliados en SALUDVIDA EPS TUTELAS';
FRMEMPRESAS.SHOW;
//FINALLY
EXCEPT
FRMEMPRESAS.FREE;
...
procedure TFRMINCAPACIDADESTUTELA.Button5Click(Sender: TObject);
begin
GLPROCESO := 'INCAPACIDADES TUTELA';
FRMPRINCIPAL.SB.PANELS[1].TEXT := 'PROCESO ABIERTO ACTUAL  :'+ GLPROCESO;
FRMAFILIADOS:=TFRMAFILIADOS.CREATE(APPLICATION);
TRY
FRMAFILIADOS.Caption:='Afiliados Activos en la Empresa TUTELAS';
FRMAFILIADOS.SHOW;
//FINALLY
EXCEPT
FRMAFILIADOS.FREE;
...
procedure TFRMINCAPACIDADESTUTELA.FormActivate(Sender: TObject);
begin
...
procedure TFRMINCAPACIDADESTUTELA.Button7Click(Sender: TObject);
begin
FRMPRESTADORES:=TFRMPRESTADORES.CREATE(APPLICATION);
TRY
FRMPRESTADORES.Caption:='Prestadores de Salud Tutela';
FRMPRESTADORES.SHOW;
//FINALLY
EXCEPT
FRMPRESTADORES.FREE;
...
procedure TFRMINCAPACIDADESTUTELA.Button6TClick(Sender: TObject);
begin
FRMDIAGNOSTICOS:=TFRMDIAGNOSTICOS.CREATE(APPLICATION);
TRY
PANTALLA:='Diagnósticos Tutela';
FRMDIAGNOSTICOS.Caption:='Diagnósticos Tutela';
...
procedure TFRMINCAPACIDADESTUTELA.imprimir_incapacidad;
var i: integer;
valor1:string;
valor2:integer;
...
//   try
   //********************************
                ...
                FRMCARTAincapacidad.QRLabel9.Caption:= '(' + FRMINCAPACIDADESTUTELA.xIntToLletres(valor2)+' PESOS M/LEGAL)';
          ...
          //para certificado de incapacidad
              ...
              frmcertificado_incapa.QRLabel59.Caption:=FRMINCAPACIDADESTUTELA.xIntToLletres(valor2);
              ...
              frmcertificado_incapa.QRLabel67.Caption:= FRMINCAPACIDADESTUTELA.xIntToLletres(valor2)+'PESOS M/LEGAL';;
...
procedure TFRMINCAPACIDADESTUTELA.Edit3Exit(Sender: TObject);
begin
if  trim(Edit3.Text) <> '' then
begin
...
procedure TFRMINCAPACIDADESTUTELA.Edit3Enter(Sender: TObject);
begin
...
PROCEDURE TFRMINCAPACIDADESTUTELA.DIASINCAPACIDADPAT;
  VAR
    DOCBEN:STRING;
  BEGIN
...
PROCEDURE TFRMINCAPACIDADESTUTELA.PAGOSININTERRUMPIDOS;
 VAR
 I,J,MESDEF:INTEGER;
...
FRMINCAPACIDADESTUTELA.EDTNOMBREEMPRESA.Text:='';
FRMINCAPACIDADESTUTELA.cbtipodocempresa.Text:='';
FRMINCAPACIDADESTUTELA.edtnumdocempresa.Text:='';
FRMINCAPACIDADESTUTELA.cbtipodocempresa.SetFocus;
END;
END;  //END WHILE
END;  //PAGOSININTERRUMPIDO

PROCEDURE TFRMINCAPACIDADESTUTELA.CUATROSEMANASAFILIACION;
BEGIN
         ...
         DATAMODULE1.qryafil4sem.Open;
                ...
                BEGIN
                   ...
                   FRMINCAPACIDADESTUTELA.cbtipodocafiliado.Text:='';
                   FRMINCAPACIDADESTUTELA.edtnumdocafiliadoin.Text:='';
                   FRMINCAPACIDADESTUTELA.cbtipodocafiliado.SetFocus;
                END;

END;  //CUATROSEMANASAFILIACION


FUNCTION TFRMINCAPACIDADESTUTELA.PROMEDIOSAL:STRING;
...
BEGIN
    ...
    END;
END;
FUNCTION TFRMINCAPACIDADESTUTELA.FECHA:STRING;
VAR
MES,DIA,YEAR: STRING;
...
FUNCTION TFRMINCAPACIDADESTUTELA.FECHAINCAPACIDAD: STRING;

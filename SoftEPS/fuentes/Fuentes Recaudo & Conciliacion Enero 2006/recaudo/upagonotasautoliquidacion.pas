...
begin
    ...
    BEGIN
        ...
        DATAMODULE1.QRYEMPRESAS.Parameters[0].Value := TRIM(DBLookupComboBox1.TEXT);
        DATAMODULE1.QRYEMPRESAS.Parameters[1].Value := TRIM(Edit1.TEXT);
        ...
        BEGIN
                ...
                DATAMODULE1.qrynotasautoliquidacion.SQL.ADD('SELECT * FROM NOTAS_AUTOLIQUIDACION WHERE TIP_NOTA = :"TIPONOTA" and TIP_DOC_EMPRESA = :"tipo"  and NUM_DOC_EMPRESA = :"numero" AND NUM_COMP_DES IS NULL');
                IF Label47.Caption = 'NOTAS  CREDITO' THEN
                begin
                DATAMODULE1.qrynotasautoliquidacion.Parameters[0].VALUE :='C';
                END
                ELSE
                IF Label47.Caption = 'NOTAS  DEBITO ' THEN
                begin
                DATAMODULE1.qrynotasautoliquidacion.Parameters[0].VALUE :='D';
                END;
                DATAMODULE1.qrynotasautoliquidacion.Parameters[1].VALUE := TRIM(DBLookupComboBox1.TEXT);
                DATAMODULE1.qrynotasautoliquidacion.Parameters[2].VALUE := TRIM(Edit1.TEXT);
...
begin
          IF MESSAGEDLG (LowerCase('descuento DE LA  '+Label47.Caption +  'Por Valor de  ' +  Edit3.text + ' ?'), MTCONFIRMATION, [MBYES, MBNO], 0) = MRYES THEN
           BEGIN
           Edit3.Text := '0';
           Edit7.Text := '0';
           Edit8.Text := '0';
...
begin
  ...
  IF (Edit3.TEXT = '') or (Edit4.TEXT = '')or (Edit3.TEXT = '0') or (Edit4.TEXT = '0') or (Edit6.TEXT = '0') or (Edit6.TEXT = '') THEN
   BEGIN
      ...
      begin
      ShowMessage(LowerCase('Debe Selecionar  la  nota   A Pagar'));
      Edit3.SetFocus;
      end;
...
begin
      ...
      DATAMODULE1.qrynotasautoliquidacion.Parameters[0].VALUE := Edit6.Text;
      DATAMODULE1.qrynotasautoliquidacion.Open;
       IF DATAMODULE1.qrynotasautoliquidacion.RecordCount > 0 THEN
       BEGIN
...
begin
 ...
 TRY
      ...
      DATAMODULE1.qrynotasautoliquidacion.Parameters[0].VALUE := Edit8.Text;
      DATAMODULE1.qrynotasautoliquidacion.Open;
...
procedure Tfrmpagonotasautoliquidacion.FormActivate(Sender: TObject);
begin

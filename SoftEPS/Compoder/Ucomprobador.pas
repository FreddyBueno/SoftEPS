...
type
  Tfrmcompoder = class(TForm)
    ...
    tblestados: TTable;
    qryfechahoy: TQuery;
    qryfechahoySYSDATE: TDateTimeField;
                ...
                if qryafiliados.eof then
                  begin
                    ...
                    begin
                          qryfechahoy.Close;
                          qryfechahoy.Open;
                          fecha_actual := qryfechahoysysdate.Value;
                          qrycotiza.Open;
                          ...
                          if qrypagos.RecordCount > 0 then
                             edit1.Text := floattostr(roundto(weeksBetween(qryafiliadosfec_afiliacion_sis.Value,fecha_actual),0))
                           else
                         ...
                         qryregistrodecomprobaciones.Params[0].AsString := qryafiliadostip_documento.Value;
                         qryregistrodecomprobaciones.Params[1].AsString := qryafiliadosnum_documento.Value;
                         ...
                         qryregistrodecomprobaciones.Params[4].AsDateTime := fecha_actual;
                         ...
                         qryregistrodecomprobaciones.Params[14].AsString := 'CC';
                         qryregistrodecomprobaciones.Params[15].AsString := '999';
...
begin
        ...
        tbltipos_documentos.Open;
        tblsexo.Open;
        tblestratos.Open;
        tbldiscapacidades.Open;
        tblestadosciviles.Open;
        tblestados.Open;
end;

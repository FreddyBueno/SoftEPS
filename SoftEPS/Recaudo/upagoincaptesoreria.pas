...
begin
    ...
    BEGIN
        ...
        DATAMODULE1.QRYAFILIADOS.PARAMS[0].ASSTRING := TRIM(DBLookupComboBox1.TEXT);
        DATAMODULE1.QRYAFILIADOS.PARAMS[1].ASSTRING := TRIM(Edit1.TEXT);
...
begin
     ...
     DATAMODULE1.QRYINCAPACIDADES.PARAMS[0].ASSTRING := '0';
     DATAMODULE1.QRYINCAPACIDADES.PARAMS[1].AsDate := STRTODATE('01/'+ GLPRESENTACION);
     DATAMODULE1.QRYINCAPACIDADES.PARAMS[2].ASSTRING := DBLookupComboBox1.TEXT;
     DATAMODULE1.QRYINCAPACIDADES.PARAMS[3].ASSTRING := Edit1.TEXT;
...
begin
    ...
    try
                ...
                BEGIN
                        ...
                        DATAMODULE1.QRYDETINCAPACIDAD.PARAMS[0].ASSTRING := Edit8.text;
                        if Edit7.Text <> '0' then
                         begin
                         DATAMODULE1.QRYDETINCAPACIDAD.PARAMS[1].ASSTRING := Edit7.text;
                         end
                         else
                          DATAMODULE1.QRYDETINCAPACIDAD.PARAMS[1].ASSTRING := StringGrid1.CELLS[0,I];
                          DATAMODULE1.QRYDETINCAPACIDAD.PARAMS[2].AsInteger := StrToInt(StringGrid1.CELLS[2,I]);
...
begin
      ...
      DATAMODULE1.QRYDETINCAPACIDAD.PARAMS[0].ASSTRING := 'C';
      DATAMODULE1.QRYDETINCAPACIDAD.PARAMS[1].ASSTRING := Edit6.TEXT;
      DATAMODULE1.QRYDETINCAPACIDAD.REQUESTLIVE := TRUE;
      DATAMODULE1.QRYDETINCAPACIDAD.OPEN;

                ...
                BEGIN
                        ...
                        BEGIN
                           ...
                           //  GLNIVELUSUARIO := StrToInt(IntToStr(QRYUSUARIOSNIV_USUARIO.VALUE));
                             ...
                             DATAMODULE1.QRYVALORESCOMPENSACION.PREPARE;
                                 IF MES <> '01' THEN
                                 BEGIN
                                 DATAMODULE1.QRYVALORESCOMPENSACION.PARAMBYNAME('PANO').VALUE := StrToDateTime('01/01/'+ANO);
                                 END
                                 ELSE IF MES = '01' THEN
                                       BEGIN
                                  ...
                                  DATAMODULE1.QRYVALORESCOMPENSACION.ENABLECONTROLS;

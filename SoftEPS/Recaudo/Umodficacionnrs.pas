...
begin
 ...
 DATAMODULE1.QRYDETALLE.PARAMS[0].ASSTRING := TRIM(EDTPERIODO.TEXT);
...
begin
 ...
 DATAMODULE1.QRYAUTOLIQUIDACION.OPEN;
   ...
   BEGIN
                ...
                DATAMODULE1.QRYAFILIADOS.PARAMS[0].ASSTRING := DATAMODULE1.qryautoliquidacionEMP_TIPO_DOC.Value;
                DATAMODULE1.QRYAFILIADOS.PARAMS[1].ASSTRING := DATAMODULE1.qryautoliquidacionEMP_NUMERO_DOC.Value;
                ...
                BEGIN
                       ...
                       qrydetalleplanilla.PARAMS[0].ASSTRING := TRIM(EDTPERIODO.TEXT);
                       qrydetalleplanilla.PARAMS[1].ASSTRING := DATAMODULE1.QRYAFILIADOSTIP_DOCUMENTO_EMP.Value;
                       qrydetalleplanilla.PARAMS[2].ASSTRING := DATAMODULE1.QRYAFILIADOSNUM_DOCUMENTO_EMP.Value;
                       qrydetalleplanilla.PARAMS[3].ASSTRING := DATAMODULE1.QRYAFILIADOSTIP_DOCUMENTO_AFI.Value;
                       qrydetalleplanilla.PARAMS[4].ASSTRING := DATAMODULE1.QRYAFILIADOSNUM_DOCUMENTO_AFI.Value;
...
begin
     ...
     begin
       ...
       exit
           ...
           DATAMODULE1.QRYDETALLE.PARAMS[0].ASSTRING := TRIM(EDIT2.TEXT);
           DATAMODULE1.QRYDETALLE.PARAMS[1].ASSTRING := TRIM(EDIT3.TEXT);
           DATAMODULE1.QRYDETALLE.PARAMS[2].ASSTRING := TRIM(estado_usuario);
           DATAMODULE1.QRYDETALLE.PARAMS[3].ASSTRING := TRIM(EDTPLANILLA.TEXT);
           DATAMODULE1.QRYDETALLE.PARAMS[4].ASSTRING := TRIM(EDIT1.TEXT);
           DATAMODULE1.QRYDETALLE.PARAMS[5].ASSTRING := TRIM(edtnumeroducafiliado.TEXT);
           DATAMODULE1.QRYDETALLE.REQUESTLIVE := TRUE;

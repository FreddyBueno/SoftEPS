...
FROM  det_planilla_autoliquidacion,afiliados,empresas, autoliquidacion
WHERE ((det_planilla_autoliquidacion.num_planilla = autoliquidacion.num_planilla ) AND 
	    ...
	    ((det_planilla_autoliquidacion.afi_tipo_doc = afiliados.tip_documento) AND
            ...
            (det_planilla_autoliquidacion.afi_tipo_doc="CC" AND
            det_planilla_autoliquidacion.afi_numero_doc ="79500567")

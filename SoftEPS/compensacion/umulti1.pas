...
begin
  ...
  dmcompensa.qrymcdecaficom1.Params[0].Value :=DATETIMEPICKER1.Date;;
  dmcompensa.qrymcdecaficom1.Open;
  dmcompensa.qrymcdecaficom1.First;
  edit1.Text := floattostr(dmcompensa.qrymcdecaficom1.RecordCount);
  i := 0;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  promdep :=redondea(((dmcompensa.qrymcupczonpyp.Value/12)/30)*strtofloat(dmcompensa.qrymcdecaficom1dias.value));
                  dmcompensa.tblbasesdepval_solidaridad.Value := redondea(((upcdep+promdep)*dmcompensa.qrymcupczonsol.Value));
                end;
                if (strtodate(fecagre) < strtodate('01/03/2000')) then
                begin
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  dmcompensa.qrymcbasesdepval_solidaridad.Value :=redondea(((dmcompensa.qrymcbasesdepval_upc_dependientes.Value+dmcompensa.qrymcbasesdepval_promocion.Value)*dmcompensa.qrymcupczonsol.Value));
                end;
              end;
              if dmcompensa.qrymcdecaficom1tip_upc.Value = 'E' then
              begin

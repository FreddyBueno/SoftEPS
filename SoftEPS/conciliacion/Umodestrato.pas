...
//         IF  COPY((DATAMODULE1.QRYAUTOLIQUIDACIONEMP_NUMERO_DOC.VALUE),1, 5) = COPY((DATAMODULE1.QRYESTRATONUM_DOCUMENTO.VALUE),1, 5) THEN
 //         BEGIN
        ...
        DOCUMENTO := DATAMODULE1.QRYESTRATONUM_DOCUMENTO.VALUE;
        DATAMODULE1.QRYAUTOLIQUIDACION.CLOSE;
        ...
        DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[0].ASSTRING := PLANILLA;
        ...
        BEGIN
          ...
          DATAMODULE1.QRYESTRATO.PARAMS[0].ASSTRING :=  DOCUMENTO;
          DATAMODULE1.QRYESTRATO.PARAMS[1].ASDATETIME :=  FECHA_RECAUDO;
          DATAMODULE1.QRYESTRATO.PARAMS[2].ASFLOAT :=  VALOR_CONSIGNADO;
          DATAMODULE1.QRYESTRATO.PARAMS[3].ASSTRING :=  TIPO;
          ...
          BEGIN
            ...
            DATAMODULE1.QRYESTRATO.PARAMS[0].ASDATE :=  (DTFINICIAL.DATE);
            DATAMODULE1.QRYESTRATO.PARAMS[1].ASDATE := (DTFFINAL.DATE);
            DATAMODULE1.QRYESTRATO.PARAMS[2].ASSTRING := 'N';
            DATAMODULE1.QRYESTRATO.PARAMS[3].ASSTRING := CBBANCOS.KEYVALUE;
            DATAMODULE1.QRYESTRATO.OPEN;
            ...
            BEGIN
              ...
              DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[0].ASDATE :=  (DTFINICIAL.DATE);
              DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[1].ASDATE := (DTFFINAL.DATE);
              DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[2].ASSTRING := 'S';
              DATAMODULE1.QRYAUTOLIQUIDACION.OPEN;
            END;
          END;
        END;
...
BEGIN
        ...
        BEGIN
                ...
                DATAMODULE1.QRYESTRATO.SQL.CLEAR;
                DATAMODULE1.QRYESTRATO.SQL.ADD('SELECT *  FROM EST_BANCARIO_AUTO WHERE (FEC_RECAUDO >= :"INICIAL" AND  FEC_RECAUDO <= :"FINAL") AND  (EST_CONCILIACION = :"ESTADO") AND COD_BANCO = :"BANCO" ORDER BY FEC_RECAUDO,VAL_CONSIGNACION,NUM_DOCUMENTO');
                DATAMODULE1.QRYESTRATO.PARAMS[0].AsDateTime :=  (DTFINICIAL.DATE);
                DATAMODULE1.QRYESTRATO.PARAMS[1].AsDateTime := (DTFFINAL.DATE);
                DATAMODULE1.QRYESTRATO.PARAMS[2].ASSTRING := 'N';
                DATAMODULE1.QRYESTRATO.PARAMS[3].ASSTRING := CBBANCOS.KEYVALUE;
                DATAMODULE1.QRYESTRATO.OPEN;
                        IF DATAMODULE1.QRYESTRATO.RECORDCOUNT = 0 THEN
...
begin
                ...
                DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[0].ASDATE := DATAMODULE1.qryestratoFEC_RECAUDO.Value;
                DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[1].ASDATE := DATAMODULE1.qryestratoFEC_RECAUDO.Value;
                DATAMODULE1.QRYAUTOLIQUIDACION.PARAMS[2].ASSTRING := 'S';
                DATAMODULE1.QRYAUTOLIQUIDACION.OPEN;

...
type
  Tfrmconsulta_nombre = class(TForm)
    Splitter1: TSplitter;
    Splitter2: TSplitter;
    Panel1: TPanel;
    Label26: TLabel;
...
var
  frmconsulta_nombre: Tfrmconsulta_nombre;
...
procedure Tfrmconsulta_nombre.BitBtn1Click(Sender: TObject);
begin
        if (edit2.Text <>'') then
        begin
            qryafiliados.close;
...
procedure Tfrmconsulta_nombre.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
        action:=cafree;
end;

procedure Tfrmconsulta_nombre.Edit2KeyPress(Sender: TObject;
  var Key: Char);
begin
